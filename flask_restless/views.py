...
class API(ModelView):
    ...
    def _extract_error_messages(self, exception):
        ...
        if hasattr(exception, 'message'):
            ...
            try:
                left, right = (exception.args[0:1] or '').rsplit(':', 1)
    ...
    def _search(self):
        ...
        To control which relations to follow, supply a JSON string in
    ...
    def post(self):
        ...
        try:
            ...
            current_app.logger.exception(exception.args[0:1] or '')
            return jsonify_status_code(400, message=exception.args[0:1] or '')
